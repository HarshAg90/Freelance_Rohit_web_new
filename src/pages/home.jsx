  ...
  return (
    <div className="w-screen min-h-screen">
      ...
      <div className="flex justify-around items-center p-10 ">
        ...
        <img
          src="./prj_img/im4.jpg"
          className="w-[50vw] h-auto shadow-md"
          alt=""
        />
      </div>
      ...
      <div className="p-10">
        <div className="w-full flex flex-col justify-center items-center my-20 gap-3">
          ...
          <p>
            Discover our fine product range and special finishes for your next
            project
          </p>
        </div>
        <div className="flex gap-4 w-full mx-10">
          <img
            src="./prj_img/im1.jpg"
            className="w-[30vw] h-[200px] shadow-md rounded-xl my-5 object-cover"
            alt=""
          />
          <img
            src="./prj_img/im5.jpg"
            className="flex-1 h-[200px] shadow-md rounded-xl my-5 object-cover"
            alt=""
          />
        </div>
        <div className="flex gap-4 w-full mx-10">
            ...
            <div className="relative group">
              ...
              <div className="mt-4">
                ...
                <p className="text-gray-700 mt-2">
                  ...
                  brand or start fresh with these insights that will empower
